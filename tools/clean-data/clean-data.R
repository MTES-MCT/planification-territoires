...
# Ajout du label
  mutate(label = case_when(
    name=="# voitures thermiques remplacées d'ici 2030" ~ "Nombre de voitures thermiques remplacées d’ici 2030",
    ...
    name=="# bus thermiques remplacés d'ici 2030" ~ "Nombre de bus thermiques remplacées d’ici 2030",
    ...
    name=="m² chauffés au fioul passés à une énergie décarbonnée d'ici 2030" ~ "m² chauffés au fioul passés à une énergie décarbonnée d’ici 2030",
    name=="m² chauffés au gaz passés à une énergie décarbonnée d'ici 2030" ~ "m² chauffés au gaz passés à une énergie décarbonnée d’ici 2030",
    name=="# logement (70m²) m2 rénovés en profondeur" ~ "Nombre de logements (70m²) rénovés en profondeur",
    name=="# chaudières au fioul passées à une énergie décarbonnée d'ici 2030" ~ "Nombre de chaudières au fioul passées à une énergie décarbonnée d’ici 2030",
    name=="# chaudières au gaz  passées à une énergie décarbonnée d'ici 2030" ~ "Nombre chaudières au gaz passées à une énergie décarbonnée d’ici 2030",
    ...
    name=="kml de haies supplémentaires d'ici 2030 (net)" ~ "Kilomètres linéaires de haies supplémentaires d’ici 2030 (nets)",
